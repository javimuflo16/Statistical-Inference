...
america_categories <- c("US", "CA", "MX")
europe_categories <- c("RU", "GB", "FR", "DE")

new_continent_ids <-
  ifelse(data$country_id %in% america_categories, "America", 
         ifelse(data$country_id %in% europe_categories, "Europe", "Asia"))

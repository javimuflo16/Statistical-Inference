...
The confidence interval (upper and lower bounds) obtained for $\mu$ is $(561.1282, 561.1435)$.
...
$$
\small
\mathrm{CI}_{0.95}(\pi) = (\hat{\pi} - Z_{0.05}\sqrt{\frac{\hat{\pi}(1-\hat{\pi})}{n}}, \hat{\pi} + Z_{0.05}\sqrt{\frac{\hat{\pi}(1-\hat{\pi})}{n}}) = (0.090, 0.092)
$$
...
CI_submean_lower <- (mu_film - mu_music) + qnorm(.025)*

...
The parameters are calculated by equaling both equations to zero, then we obtain that $\hat\mu_{MLE}=\frac{1}{n}\sum_{i=1}^n\log{x_i}$ and $\hat\sigma^2_{MLE}=\frac{1}{n}\sum_{i=1}^n(\log{x_i}-\hat\mu)^2$.
